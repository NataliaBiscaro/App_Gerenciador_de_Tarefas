...
DocumentReference? get currentUserReference => loggedIn
    ? Gersonalorganizer67547Record.collection.doc(currentUser!.uid)
    : null;

Gersonalorganizer67547Record? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : Gersonalorganizer67547Record.getDocument(
                  Gersonalorganizer67547Record.collection.doc(uid))
              .handleError((_) {}),
    )
